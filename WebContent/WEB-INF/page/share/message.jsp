...
<tr>
	<td align="center">
		<table width="305" border="0" cellpadding="0" cellspacing="0" align="center">
		  <tr>
			<td height="212" align="center" valign="middle" bgcolor="1491c6"><table width="295" border="0" cellpadding="0" bgcolor="#FFFFFF">
			  <tr>
					...
					<table width="273" border="0" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF">
					  ...
					  <tr>
						<td height="80" align="center" valign="middle"><font size="2"><span class="content">
						 <input type="button" name="sure" value="Confirm"
						 onclick="javascript:window.location.href='<%=request.getContextPath() %>${urladdress}'"
						 >
						</span></font></td>
					  </tr>
					</table>
