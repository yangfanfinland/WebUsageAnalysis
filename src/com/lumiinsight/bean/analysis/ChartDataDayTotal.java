...
@Entity
public class ChartDataDayTotal {
	...
	public ChartDataDayTotal() {}
	public ChartDataDayTotal(String dataID, Integer totalConnection,
			Integer totalComplete, Integer totalInteraction,
			Integer totalEvents, String serverName, String serverCategory,
			String year, String month, String day, String weekDay,
			String weekInYear) {
		super();
		this.dataID = dataID;
